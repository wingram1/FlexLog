...
function ExerciseList(props) {
  ...
  const [exerciseCounter, setExerciseCounter] = useState(
    activeWorkout.workout.exercises[activeWorkout.workout.exercises.length - 1]
      .id + 1
  );
        ...
        >
          ...
          <div className={classes.inputContainer}>
            ...
            <input
              ...
              placeholder={exerciseData[exercise].name}
          ...
          <div className={classes.inputContainer}>
            ...
            <input
              ...
              className={classes.input}
              min="1"
              placeholder={exerciseData[exercise].settings.sets}
              data-id={exerciseData[exercise].id}
          ...
          <div className={classes.inputContainer}>
            ...
            <input
              className={classes.input}
              type="number"
              placeholder={exerciseData[exercise].settings.rest}
              min="0"
              data-id={exerciseData[exercise].id}
